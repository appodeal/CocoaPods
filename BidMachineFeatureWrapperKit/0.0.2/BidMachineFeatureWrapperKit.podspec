Pod::Spec.new do |spec|
  spec.name                     = "BidMachineFeatureWrapperKit"
  spec.version                  = "0.0.2"
  spec.summary                  = "BidMachineFeatureWrapperKit iOS"
  ...
  spec.vendored_frameworks = 'BidMachineFeatureWrapperKit.xcframework' 
  spec.resources = "BidMachineFeatureWrapperKit.bundle"
