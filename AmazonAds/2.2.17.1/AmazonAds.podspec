...
These materials are distributed on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
  ...
  s.source       = { :http => "https://s3-us-west-1.amazonaws.com/appodeal-ios/external-sdks/AmazonSDK/2.2.17.1/AmazonAd.framework.zip" }
  s.vendored_frameworks = 'AmazonAd.framework'

  s.frameworks = "AdSupport", "CoreLocation", "SystemConfiguration", "JavaScriptCore", "StoreKit", "QuartzCore", "SafariServices", "CoreTelephony", "CoreGraphics", "MediaPlayer", "EventKit", "EventKitUI"
