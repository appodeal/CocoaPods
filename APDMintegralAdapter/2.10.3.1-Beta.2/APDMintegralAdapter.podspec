...
Pod::Spec.new do |spec|
  ...
  Appodeal’s goal is to cater to the needs of the publisher, not the advertiser, so you always know that you’re in good hands.
	...
	spec.dependency "MintegralAdSDK", "6.6.0.0"
	spec.dependency "MintegralAdSDK/RewardVideoAd", "6.6.0.0"
	spec.dependency "MintegralAdSDK/InterstitialVideoAd", "6.6.0.0"
	spec.dependency "MintegralAdSDK/InterstitialAd", "6.6.0.0"
end
