...
Pod::Spec.new do |spec|
  ...
  Appodeal's goal is to cater to the needs of the publisher, not the advertiser, so you always know that you"re in good hands.
	...
	spec.dependency "MintegralAdSDK", "~> 5.9.0"
 	spec.dependency "MintegralAdSDK/RewardVideoAd", "~> 5.9.0"
  	spec.dependency "MintegralAdSDK/InterstitialVideoAd", "~> 5.9.0"
  	spec.dependency "MintegralAdSDK/InterstitialAd", "~> 5.9.0"
end
