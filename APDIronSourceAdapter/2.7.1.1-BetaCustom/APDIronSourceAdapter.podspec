...
Pod::Spec.new do |spec|
  ...
  Appodeal's goal is to cater to the needs of the publisher, not the advertiser, so you always know that you're in good hands.
	...
	spec.vendored_libraries 	= "APDIronSourceAdapter.embeddedframework/*.a"
	spec.vendored_frameworks 	= "APDIronSourceAdapter.embeddedframework/IronSource.framework"
	
	spec.swift_versions 		= "4.0", "4.2", "5.0"
	spec.source_files 	= "Dummy.swift"
	spec.dependency "Appodeal", "2.7.1-BetaCustom"
	spec.frameworks 	= 'Foundation', 'CoreVideo', 'CFNetwork', 'AudioToolbox'
end
