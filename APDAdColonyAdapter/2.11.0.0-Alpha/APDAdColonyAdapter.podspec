...
Pod::Spec.new do |spec|
  ...
  Appodeal’s goal is to cater to the needs of the publisher, not the advertiser, so you always know that you’re in good hands.
	...
	spec.vendored_frameworks 	= "#{spec.name}-#{spec.version}/#{spec.name}.xcframework"
	spec.swift_versions 		= "4.0", "4.2", "5.0"
	  
	spec.dependency "Appodeal", "2.11.0-Alpha"
	spec.dependency "AdColony", "4.7.2"
	spec.dependency "BDMAdColonyAdapter", "~> 1.8.0.0"
