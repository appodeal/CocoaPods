Pod::Spec.new do |s|
  ...
  s.name         = "Appodeal"
  s.version      = "0.9.0-light.banners.interstitials"
...
Appodeal's goal is to cater to the needs of the publisher, not the advertiser, so you always know that you're in good hands.
  ...
  s.platform     = :ios, "7.1"
  s.source       = { :http => "https://s3-us-west-1.amazonaws.com/appodeal-ios/0.9.0/pods/light.banners.interstitials/Appodeal.zip" }
