Pod::Spec.new do |s|
  ...
  s.name         = "Appodeal"
  s.version      = "0.6.0-light.bannersinterstitials"
...
Appodeal's goal is to cater to the needs of the publisher, not the advertiser, so you always know that you're in good hands.
  ...
  s.platform     = :ios, "7.0"
  s.source       = { :http => "https://s3-us-west-1.amazonaws.com/appodeal-ios/0.6.0/pods/light.bannersinterstitials/Appodeal.zip" } 
