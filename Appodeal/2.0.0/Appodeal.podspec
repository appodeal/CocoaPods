...
Appodeal's goal is to cater to the needs of the publisher, not the advertiser, so you always know that you're in good hands.
  ...
  s.platform     = :ios, "8.0"
  s.source       = { :http => "https://s3-us-west-1.amazonaws.com/appodeal-ios/2.0.0/cocoapods/Appodeal.zip" }
  ...
  s.subspec 'Banner' do |ss|
    ...
    ss.dependency 'Appodeal/ZPlayAdapter'
  end
  ...
  s.subspec 'AmazonAdsAdapter' do |ss|
    ...
    ss.frameworks = "JavaScriptCore", "EventKit", "EventKitUI", "SafariServices"
    ss.dependency 'Appodeal/Core'
  end
  ...
  s.subspec 'GoogleAdMobAdapter' do |ss|
    ...
    ss.frameworks = "AudioToolbox", "CoreBluetooth", "CoreMedia", "CoreMotion", "CoreVideo", "EventKit", "EventKitUI", "GLKit", "MessageUI", "OpenGLES", "MobileCoreServices"
  ...
  s.subspec 'ZPlayAdapter' do |ss|
    ss.vendored_libraries = "APDZplayAdapter.embeddedframework/*.a"
    ss.dependency 'Appodeal/Core'
  end
  ...
  s.subspec 'IronSource' do |ss|
    ...
    ss.resources = "APDIronSourceAdapter.embeddedframework/Resources/*"
    ss.dependency 'Appodeal/Core'
  end
