...
Appodeal's goal is to cater to the needs of the publisher, not the advertiser, so you always know that you're in good hands.
  ...
  s.platform     = :ios, "8.0"
  s.source       = { :http => "https://s3-us-west-1.amazonaws.com/appodeal-ios/1.3.8/cocoapods/Appodeal.zip" }
  ...
  s.subspec 'TwitterMoPubAdapter' do |ss|
    ...
    ss.source_files = "APDTwitterMoPubAdapter.embeddedframework/Headers/*.h"
