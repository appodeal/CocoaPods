...
Pod::Spec.new do |spec|
  ...
  Appodeal's goal is to cater to the needs of the publisher, not the advertiser, so you always know that you're in good hands.
	...
	spec.frameworks 	= 'CoreData', 'CFNetwork', 'CoreMotion', 'EventKitUI', 'EventKit', 'Foundation', 'MapKit', 'MessageUI'
	spec.libraries 		= 'sqlite3.0', 'c++'
	spec.resources 		= 'APDTapjoyAdapter.embeddedframework/Resources/TapjoyResources.bundle'
end
