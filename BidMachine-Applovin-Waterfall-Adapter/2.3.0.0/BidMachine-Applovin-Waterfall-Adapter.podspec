Pod::Spec.new do |spec|
  ...
  spec.source                   = { :http => "https://s3-us-west-1.amazonaws.com/appodeal-ios/BidMachineMaxAdapter/2.3.0.2-Beta.2/BidMachineMaxAdapter.zip" }

  spec.vendored_frameworks = 'BidMachineMaxAdapter.xcframework' 
  spec.dependency 'BidMachine', '~> 2.3.0.0'
