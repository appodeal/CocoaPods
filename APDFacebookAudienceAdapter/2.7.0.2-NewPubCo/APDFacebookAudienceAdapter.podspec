...
Pod::Spec.new do |spec|
  ...
  Appodeal's goal is to cater to the needs of the publisher, not the advertiser, so you always know that you're in good hands.
	...
	spec.source       = { :http => "https://s3-us-west-1.amazonaws.com/appodeal-ios/Appodeal/Modular/APDFacebookAudienceAdapter/2.7.0.1-NewPubCo/APDFacebookAudienceAdapter.zip" }
