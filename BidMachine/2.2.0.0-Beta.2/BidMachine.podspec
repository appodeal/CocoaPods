Pod::Spec.new do |spec|
  ...
  spec.subspec 'Core' do |ss|
   ...
   spec.subspec 'BiddingCore' do |ss|
    ...
    ss.dependency 'BidMachine/ApiCore'
    ss.dependency 'StackIAB', '~> 2.1.0'
    ss.dependency 'StackModules', '~> 1.5.0'
   end

   spec.subspec 'ModulesCore' do |ss|
    ss.vendored_frameworks = 'BidMachineModules.xcframework', 'SwiftProtobuf.xcframework'
    ss.dependency 'BidMachine/ApiCore'
   end
