Pod::Spec.new do |s|
  ...
  s.platform     = :ios, '9.0'
  s.source       = { :http => "https://s3-us-west-1.amazonaws.com/appodeal-ios/BidMachine/1.4.3/BidMachine-SDK-iOS-1.4.3.zip" }
  ...
  s.subspec 'MyTargetAdapter' do |ss|
    ...
    ss.dependency 'BidMachine/Core' 
    ss.dependency 'myTargetSDK', '5.4.4'
  end
  ...
  s.subspec 'SmaatoAdapter' do |ss|
    ...
    ss.dependency 'BidMachine/Core'
    ss.dependency 'smaato-ios-sdk', '21.3.1'
    ss.dependency 'smaato-ios-sdk/Modules/UnifiedBidding', '21.3.1'
  end
end
