Pod::Spec.new do |spec|
  ...
  spec.dependency 'BidMachineApiCore', '~> 0.0.2'
  spec.dependency 'BidMachineNetworkCore', '~> 0.0.1'
  spec.dependency 'BidMachineDisplayCore', '~> 0.0.2'
  spec.dependency 'BidMachineBiddingCore', '~> 0.0.2'
  spec.dependency 'BidMachineAnalyticsCore', '~> 0.0.1'
end
