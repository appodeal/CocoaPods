Pod::Spec.new do |spec|
  ...
  spec.dependency 'BidMachineApiCore', '~> 0.3.0'
  spec.dependency 'BidMachineProtoCore', '~> 0.3.0'
  spec.dependency 'BidMachineNetworkCore', '~> 0.3.0'
  spec.dependency 'BidMachineDisplayCore', '~> 0.4.0'
  spec.dependency 'BidMachineBiddingCore', '~> 0.3.0'
  spec.dependency 'BidMachineAnalyticsCore', '~> 0.4.0'
end
