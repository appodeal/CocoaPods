...
Pod::Spec.new do |spec|
  ...
  Appodeal's goal is to cater to the needs of the publisher, not the advertiser, so you always know that you're in good hands.
	...
	spec.source       = { :http => "https://s3-us-west-1.amazonaws.com/appodeal-ios/Appodeal/Modular/APDBidMachineAdapter/#{spec.version}/APDBidMachineAdapter.zip" }
	
	spec.static_framework 		= true
	spec.swift_versions 		= "4.0", "4.2", "5.0"
	spec.vendored_libraries 	= "APDBidMachineAdapter.embeddedframework/*.a"
	spec.vendored_frameworks 	= "APDBidMachineAdapter.embeddedframework/*.framework"
