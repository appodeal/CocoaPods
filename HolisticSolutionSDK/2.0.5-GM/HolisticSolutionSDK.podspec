Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/appodeal/Stack-HolisticSolutionSDK-iOS.git", :tag => "v2.0.5" }
  ...
  spec.subspec "Core" do |ss|
    ...
    ss.dependency "Appodeal", "2.11.1-GM"
  ...
  spec.subspec "AdNetworks" do |ss|
    ss.dependency 'APDAdColonyAdapter', '2.11.1-GM'
    ss.dependency 'APDAmazonAdsAdapter', '2.11.1-GM'
    ss.dependency 'APDAppLovinAdapter', '2.11.1-GM'
    ss.dependency 'APDBidMachineAdapter', '2.11.1-GM'
    ss.dependency 'APDFacebookAudienceAdapter', '2.11.1-GM'
    ss.dependency 'APDGoogleAdMobAdapter', '2.11.1-GM'
    ss.dependency 'APDIronSourceAdapter', '2.11.1-GM'
    ss.dependency 'APDMyTargetAdapter', '2.11.1-GM'
    ss.dependency 'APDOguryAdapter', '2.11.1-GM'
    ss.dependency 'APDUnityAdapter', '2.11.1-GM'
    ss.dependency 'APDVungleAdapter', '2.11.1-GM'
    ss.dependency 'APDYandexAdapter', '2.11.1-GM'
  end
