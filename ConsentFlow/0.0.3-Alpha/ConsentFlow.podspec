Pod::Spec.new do |spec|
  ...
  spec.source       = {  :http => "https://s3-us-west-1.amazonaws.com/appodeal-ios/#{spec.name}/swiftpm/#{spec.version}/#{spec.name}.zip" }

  spec.dependency 'Appodeal', '3.1.0-MB.1'
  spec.swift_versions = "4.0", "4.2", "5.0"
  spec.vendored_frameworks = 'ConsentFlow.xcframework'
