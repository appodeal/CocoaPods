...
s.source       = { :git => "https://github.com/bidmachine/AppLovin-MAX-SDK-iOS.git", :branch => "v2.6.1-scopely.0" }
s.source_files = 'BidMachine/BidMachineAdapter/*.{h,m}'
s.static_framework = true

s.dependency 'BidMachine', '2.6.1-scopely.0'
