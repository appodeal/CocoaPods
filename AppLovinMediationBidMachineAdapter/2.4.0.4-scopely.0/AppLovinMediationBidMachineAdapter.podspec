...
s.source       = { :git => "https://github.com/bidmachine/AppLovin-MAX-SDK-iOS.git", :tag => "v2.4.0.4-scopely.0" }
s.source_files = 'BidMachine/BidMachineAdapter/*.{h,m}'
s.static_framework = true

s.dependency 'BidMachine', '2.4.0.4-scopely.0'
