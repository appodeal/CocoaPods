...
s.source       = { :git => "git@github.com:bidmachine/AppLovin-MAX-SDK-iOS.git", :branch => "bidmachine-update-2.1.0.0" }
s.source_files = 'BidMachine/BidMachineAdapter/*.{h,m}'
s.static_framework = true

s.dependency 'BidMachine', '~> 2.1.0.0-Beta.2'
